...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      estimate_line_evidence: {
        Row: {
          id: string
          project_id: string
          user_id: string
          verified_estimate_result_id: string
          line_key: string
      ...
      export_jobs: {
        Row: {
          ...
          project_id: string
          user_id: string
          verified_estimate_result_id: string | null
          export_type: string
          status: string
          metadata: Json | null
          created_at: string
      ...
      extracted_entities: {
        Row: {
          ...
          user_id: string
          document_version_id: string | null
          document_sheet_id: string | null
          sheet_region_id: string | null
          page_number: number | null
          entity_type: string
          payload: Json
