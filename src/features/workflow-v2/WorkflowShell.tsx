...
export default function WorkflowShell({ projectId, project }: Props) {
  ...
  return (
    <div className="workflow-v2 flex h-full min-h-0 text-foreground" style={{ background: "hsl(var(--background))" }}>
      <div className="flex-1 min-w-0 min-h-0 overflow-hidden">
        <div className="h-full overflow-x-auto overflow-y-hidden">
          <div className="flex min-h-full min-w-[1280px] flex-col">
            ...
            <div className="flex-1 min-h-0 overflow-y-auto overflow-x-visible" style={{ background: "hsl(var(--background))" }}>
